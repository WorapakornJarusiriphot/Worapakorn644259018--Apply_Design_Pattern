<?php
session_start();
require_once 'db.php';  // Assume $conn is set up here
...
try {
    // Ensure that $_SESSION['user_type'] is set and valid before using it
    if(!isset($_SESSION['user_type'])) {
        throw new Exception("User type is not set.");
    }
    
    $user = UserFactory::createUser($_SESSION['user_type'], $conn);
    
    // Use the $user object for various operations...
